...
//        long number = 555555555555555555555555555555555;
        BigInteger bigInteger1 = new BigInteger("5555555555555555555555555555");
        BigInteger bigInteger2 = new BigInteger("22222222222222222222222222222222222");

        // metody klasy big integer
        BigInteger bigIntegerAdd = bigInteger1.add(bigInteger2);
        BigInteger bigIntegerSub = bigInteger2.subtract(bigInteger1);
        ...
        BigDecimal bigDecimal = new BigDecimal("22222.22222222222222222222222222222222");
